...
const en: TranslationMap = {
  ...
  'tinyplaceOrchestration.composer.placeholder': 'Message OpenHuman…',
  ...
  'tinyplaceOrchestration.attention.open': 'Open',
  'tinyplaceOrchestration.attention.kind.approval': 'Approval',
