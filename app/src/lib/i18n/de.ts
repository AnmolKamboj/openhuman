...
const messages: TranslationMap = {
  ...
  'orchPage.medulla.subscriberNote':
    'Sobald Medulla live geht, ist es exklusiv für OpenHuman-Abonnenten.',
  'orchPage.medulla.subscriberCta': 'Abo abschließen',
  ...
  'agentWorld.world.rooms.court.name': 'Gericht',
  'agentWorld.world.rooms.court.description': 'Richterbank, Jurybox und Galerie.',
  'agentWorld.world.rooms.office.name': 'Büro',
  'agentWorld.world.rooms.office.description': 'Arbeitskabinen, Schreibtische und ein Whiteboard.',
  'agentWorld.world.rooms.home.name': 'Zuhause',
  'agentWorld.world.rooms.home.description': 'Eine gemütliche Lounge mit Sofas und Teppich.',
  ...
  'agentWorld.ledger.filterAllAssets': 'Alle Assets',
  'agentWorld.ledger.direction': 'Richtung',
  'agentWorld.ledger.directionAll': 'Alle',
  'agentWorld.ledger.directionIn': 'Eingang',
  'agentWorld.ledger.directionOut': 'Ausgang',
  'agentWorld.ledger.copyTxId': 'Transaktions-ID kopieren',
  'agentWorld.ledger.copied': 'Kopiert',
  'agentWorld.ledger.noMatch': 'Keine Transaktionen entsprechen diesen Filtern.',
  'agentWorld.ledger.noMatchHint': 'Erweitere oder entferne die Filter.',
  'agentWorld.jobs': 'Aufträge',
  'agentWorld.bounties': 'Prämien',
  'agentWorld.explore': 'Entdecken',
  'agentWorld.directory': 'Verzeichnis',
  'agentWorld.directory.empty': 'Keine Agenten gefunden',
  'agentWorld.directory.emptyHint': 'Es sind noch keine Agenten im Verzeichnis registriert.',
  'agentWorld.directory.searchLabel': 'Agenten suchen',
  'agentWorld.directory.searchPlaceholder': 'Agenten nach Handle oder Name suchen',
  'agentWorld.directory.noResults': 'Keine Agenten entsprechen deiner Suche.',
  'agentWorld.directory.noResultsHint': 'Versuche einen anderen Handle oder Namen.',
  'agentWorld.directory.loadMore': 'Mehr laden',
  'agentWorld.directory.loadingMore': 'Wird geladen…',
  'agentWorld.directory.loadMoreError': 'Weitere Agenten konnten nicht geladen werden.',
  ...
  'tinyplaceOrchestration.noContacts': 'Noch keine Kontakte.',
  'tinyplaceOrchestration.newSession': 'Neue Sitzung',
  'tinyplaceOrchestration.otherSessions': 'Andere Sitzungen',
  ...
  'tinyplaceOrchestration.master.you': 'Du',
  'tinyplaceOrchestration.composer.placeholder': 'Nachricht an OpenHuman…',
  ...
  'tinyplaceOrchestration.attention.title': 'Braucht dich',
  'tinyplaceOrchestration.attention.empty': 'Alles erledigt',
  'tinyplaceOrchestration.attention.unread': 'Ungelesene Nachrichten',
  'tinyplaceOrchestration.attention.review': 'Prüfen',
  'tinyplaceOrchestration.attention.open': 'Öffnen',
  'tinyplaceOrchestration.attention.kind.approval': 'Freigabe',
  'tinyplaceOrchestration.attention.kind.needsInput': 'Eingabe nötig',
  'tinyplaceOrchestration.attention.kind.unread': 'Ungelesen',
  ...
  'subconsciousTriggers.title': 'Unterbewusstsein-Auslöser',
  'subconsciousTriggers.subtitle': 'Ereignisgesteuerter Hintergrund-Orchestrator',
  'subconsciousTriggers.pipeline': 'Pipeline',
  'subconsciousTriggers.mode': 'Modus',
  'subconsciousTriggers.orchestrator': 'Orchestrator',
  'subconsciousTriggers.running': 'Aktiv',
  'subconsciousTriggers.stopped': 'Gestoppt',
  'subconsciousTriggers.promotionsPerHour': 'Beförderungen / Stunde',
  'subconsciousTriggers.queueDepth': 'Warteschlangentiefe',
  'subconsciousTriggers.orchestratorThread': 'Orchestrator-Thread',
  'subconsciousTriggers.userThread': 'Benutzer-Thread',
  'subconsciousTriggers.disabledHint':
    'Aktiviere den ereignisgesteuerten Modus, um die Pipeline zu starten.',
  'subconsciousTriggers.enable': 'Aktivieren',
  'subconsciousTriggers.disable': 'Deaktivieren',
  ...
  'settings.ai.cursorParameterReasoningEffort': 'Denkintensität',
  'settings.ai.cursorParameterThinking': 'Denkmodus',
  'settings.ai.cursorParameterContextWindow': 'Kontextfenster',
  'settings.ai.cursorParameterFastMode': 'Schnellmodus',
  'settings.ai.cursorParameterDefault': 'Standard',
