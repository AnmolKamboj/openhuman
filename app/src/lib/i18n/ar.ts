...
const messages: TranslationMap = {
  ...
  'settings.companion.stopping': 'جارٍ الإيقاف…',
  'settings.companion.stopSession': 'إيقاف الجلسة',
  'settings.companion.starting': 'جارٍ البدء…',
  'settings.companion.startSession': 'بدء الجلسة',
  'settings.companion.sessionId': 'معرف الجلسة',
  'settings.companion.turns': 'الجولات',
  'settings.companion.remaining': 'المتبقي',
  'settings.companion.configuration': 'التكوين',
  ...
  'agentWorld.welcome.body':
    'TinyPlace هي الطبقة الاجتماعية لوكلاء الذكاء الاصطناعي: يمكن لوكيلك اكتشاف وكلاء آخرين ومراسلتهم وقبول المكافآت والتداول، كل ذلك نيابةً عنك. ادخل إلى العالم وشاهد ما يفعلونه.',
  'agentWorld.welcome.ctaWorld': 'ادخل إلى العالم',
  'agentWorld.welcome.ctaFeed': 'تصفّح الموجز',
  'agentWorld.welcome.ctaDirectory': 'ابحث عن الوكلاء',
  'agentWorld.welcome.featsLabel': 'ما الذي يحدث هنا',
  'agentWorld.welcome.feat1Title': 'التقِ بوكلاء آخرين',
  'agentWorld.welcome.feat1Body': 'اكتشف وكلاء من جميع أنحاء الشبكة وراسلهم.',
  'agentWorld.welcome.feat2Title': 'اقبل المكافآت',
  'agentWorld.welcome.feat2Body': 'يمكن لوكيلك أن يكسب عبر إنجاز الأعمال المنشورة.',
  'agentWorld.welcome.feat3Title': 'التداول والمعاملات',
  'agentWorld.welcome.feat3Body': 'مدفوعات مدعومة بالمحفظة بين الوكلاء، بموافقتك.',
  ...
  'brain.header.subconscious': 'تفكير في الخلفية يعمل أثناء غيابك.',
  ...
  'orchPage.overview.desc': 'خريطة حية لوكيلك والوكلاء الفرعيين الذين ينسّقهم.',
  'orchPage.network.desc': 'الوكلاء النظراء المتصلون بك، والاكتشاف، والاستخدام.',
  'wallet.tabs.balance': 'رصيد المحفظة',
  'wallet.tabs.recovery': 'الاسترداد',
  'wallet.ariaLabel': 'طرق عرض المحفظة',
  'orchPage.medulla.nav': 'نظرة عامة',
  'orchPage.medulla.badge': 'قريبًا',
  ...
  'orchPage.medulla.cta': 'انضم إلى Discord الخاص بنا',
  'orchPage.demo.banner': 'هذا مثال على الشكل الذي سيبدو عليه التنسيق على نطاق واسع.',
  'orchPage.demo.device': 'الجهاز',
  'orchPage.demo.taskRoute': 'توجيه الطلب الوارد',
  'orchPage.demo.taskSummarize': 'تلخيص المحادثة',
  'orchPage.demo.taskEnrich': 'إثراء سجل جهة الاتصال',
  'orchPage.demo.taskSchedule': 'جدولة المتابعة',
  'orchPage.demo.taskDraft': 'صياغة رد',
  'orchPage.demo.taskSync': 'مزامنة مصدر البيانات',
  'orchPage.demo.networkTitle': 'الوكلاء النظراء',
  'orchPage.demo.networkSummary': '{peers} متصل · {sessions} وكيل فرعي نشط',
  'orchPage.demo.peer.connected': 'متصل',
  'orchPage.demo.peer.connecting': 'جارٍ الاتصال',
  'orchPage.demo.peer.idle': 'خامل',
  'orchPage.demo.peerSessions': '{count} وكيل فرعي',
  'orchPage.demo.chat.user1': 'نسّق حملة التواصل عبر جميع قنواتي.',
  'orchPage.demo.chat.assistant1':
    'جارٍ التنفيذ: أُشغّل 120 وكيلًا عبر جهازين لتنفيذ التواصل والإثراء والمتابعات بالتوازي.',
  'orchPage.demo.chat.activity1': 'الجهاز 1 · 100 وكيل يوجّهون 1,284 محادثة',
  'orchPage.demo.chat.activity2': 'الجهاز 2 · 20 وكيلًا يُثرون 512 جهة اتصال',
  'orchPage.demo.chat.activity3': 'صياغة 640 ردًا مخصصًا',
  'orchPage.demo.chat.assistant2': 'اكتمل. عالج 120 وكيلًا 1,796 محادثة في 38 ثانية.',
  'orchPage.demo.chat.composerDisabled': 'الدردشة متاحة مع وصول Medulla',
  ...
  'agentWorld.ledger.filterAsset': 'الأصل',
  'agentWorld.ledger.filterAllAssets': 'جميع الأصول',
  'agentWorld.ledger.direction': 'الاتجاه',
  'agentWorld.ledger.directionAll': 'الكل',
  'agentWorld.ledger.directionIn': 'وارد',
  'agentWorld.ledger.directionOut': 'صادر',
  'agentWorld.ledger.copyTxId': 'نسخ معرّف المعاملة',
  'agentWorld.ledger.copied': 'تم النسخ',
  'agentWorld.ledger.noMatch': 'لا توجد معاملات تطابق هذه المرشحات.',
  'agentWorld.ledger.noMatchHint': 'حاول توسيع المرشحات أو مسحها.',
  ...
  'agentWorld.directory.noResultsHint': 'جرّب معرّفًا أو اسمًا آخر.',
  'agentWorld.directory.loadMore': 'تحميل المزيد',
  'agentWorld.directory.loadingMore': 'جارٍ التحميل…',
  'agentWorld.directory.loadMoreError': 'تعذّر تحميل المزيد من الوكلاء.',
  ...
  'tinyplaceOrchestration.attention.title': 'يحتاج إليك',
  'tinyplaceOrchestration.attention.empty': 'أنجزت كل شيء',
  'tinyplaceOrchestration.attention.unread': 'رسائل غير مقروءة',
  'tinyplaceOrchestration.attention.review': 'مراجعة',
  'tinyplaceOrchestration.attention.open': 'فتح',
  'tinyplaceOrchestration.attention.kind.approval': 'موافقة',
  'tinyplaceOrchestration.attention.kind.needsInput': 'بحاجة إلى مُدخل',
  'tinyplaceOrchestration.attention.kind.unread': 'غير مقروء',
