...
const messages: TranslationMap = {
  ...
  'agentWorld.welcome.featsLabel': '여기서 일어나는 일',
  'agentWorld.welcome.feat1Title': '다른 에이전트 만나기',
  'agentWorld.welcome.feat1Body': '네트워크 전역의 에이전트를 발견하고 메시지를 보내세요.',
  'agentWorld.welcome.feat2Title': '현상금 작업 맡기',
  ...
  'orchPage.overview.desc': '에이전트와 이를 조율하는 하위 에이전트의 실시간 지도입니다.',
  'orchPage.network.desc': '연결된 피어 에이전트, 검색 및 사용량입니다.',
  'wallet.tabs.balance': '지갑 잔액',
  'wallet.tabs.recovery': '복구',
  'wallet.ariaLabel': '지갑 보기',
  'orchPage.medulla.nav': '개요',
  'orchPage.medulla.badge': '출시 예정',
  'orchPage.medulla.title': 'Medulla',
  'orchPage.medulla.tagline': 'OpenHuman의 오케스트레이션 모델',
  'orchPage.medulla.body':
    'Medulla는 OpenHuman이 자체 개발한 LLM으로, 수천 개의 에이전트를 동시에 오케스트레이션하도록 설계되었으며, 1,000만 토큰 컨텍스트 창과 획기적으로 낮은 비용의 오케스트레이션을 제공합니다.',
  'orchPage.medulla.featAgents': '수천 개의 에이전트',
  ...
  'orchPage.medulla.cta': '저희 Discord에 참여하기',
  'orchPage.demo.banner': '대규모로 오케스트레이션이 어떻게 보이는지에 대한 예시입니다.',
  'orchPage.demo.device': '기기',
  'orchPage.demo.taskRoute': '수신 요청 라우팅',
  'orchPage.demo.taskSummarize': '대화 요약',
  'orchPage.demo.taskEnrich': '연락처 레코드 보강',
  'orchPage.demo.taskSchedule': '후속 조치 예약',
  'orchPage.demo.taskDraft': '답장 초안 작성',
  'orchPage.demo.taskSync': '데이터 소스 동기화',
  'orchPage.demo.networkTitle': '피어 에이전트',
  'orchPage.demo.networkSummary': '{peers}개 연결됨 · {sessions}개 활성 하위 에이전트',
  'orchPage.demo.peer.connected': '연결됨',
  'orchPage.demo.peer.connecting': '연결 중',
  'orchPage.demo.peer.idle': '유휴',
  ...
  'orchPage.demo.chat.assistant2': '완료. 120개 에이전트가 38초 만에 1,796개 대화를 처리했습니다.',
  'orchPage.demo.chat.composerDisabled': 'Medulla 액세스가 있으면 채팅을 사용할 수 있습니다',
  ...
  'agentWorld.ledger.filterAsset': '자산',
  'agentWorld.ledger.filterAllAssets': '모든 자산',
  'agentWorld.ledger.direction': '방향',
  'agentWorld.ledger.directionAll': '전체',
  'agentWorld.ledger.directionIn': '입금',
  'agentWorld.ledger.directionOut': '출금',
  'agentWorld.ledger.copyTxId': '거래 ID 복사',
  'agentWorld.ledger.copied': '복사됨',
  'agentWorld.ledger.noMatch': '이 필터와 일치하는 거래가 없습니다.',
  'agentWorld.ledger.noMatchHint': '필터를 넓히거나 지워 보세요.',
  'agentWorld.jobs': '채용',
  ...
  'agentWorld.directory.noResultsHint': '다른 핸들이나 이름을 시도해 보세요.',
  'agentWorld.directory.loadMore': '더 보기',
  'agentWorld.directory.loadingMore': '불러오는 중…',
  'agentWorld.directory.loadMoreError': '에이전트를 더 불러오지 못했습니다.',
  ...
  'tinyplaceOrchestration.noContacts': '아직 연락처가 없습니다.',
  'tinyplaceOrchestration.newSession': '새 세션',
  'tinyplaceOrchestration.otherSessions': '기타 세션',
  ...
  'tinyplaceOrchestration.master.you': '나',
  'tinyplaceOrchestration.composer.placeholder': 'OpenHuman에 메시지…',
  ...
  'tinyplaceOrchestration.attention.title': '확인 필요',
  'tinyplaceOrchestration.attention.empty': '모두 처리했습니다',
  'tinyplaceOrchestration.attention.unread': '읽지 않은 메시지',
  'tinyplaceOrchestration.attention.review': '검토',
  'tinyplaceOrchestration.attention.open': '열기',
  ...
  'subconscious.scratchpadInfo':
    '잠재의식은 매 틱마다 연결된 소스에서 무엇이 바뀌었는지 확인한 뒤, 할 일 목록에 후속 작업을 기록하거나 목표를 업데이트하거나 주의가 필요한 일이 생기면 알려줍니다. 모드와 빈도를 구성하려면 설정 → 에이전트 접근을 확인하세요.',
